...
var ContentScript = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(ContentScript, [{
    ...
    value: function log(level, message) {
      ...
      console.log(now);
      console.log('IIIIIIIIIIIIIIIIIIIIIIS NOW'); //const timestamp = now //+ '-' + LOG_NUMBER.padStart(4, '0')
...
class DummycliskContentScript extends cozy_clisk_dist_contentscript__WEBPACK_IMPORTED_MODULE_0__.ContentScript {
